...
-- MAGIC %run "/Workspace/Users/euheniy.khvoinitski@gmail.com/data-engineering-with-databricks/DE 6 - Managing Permissions/Includes/Classroom-Setup-06.3"
...
GRANT USAGE ON CATALOG euheniy_khvoinitski_3tu9_da TO `account users`;
...
-- MAGIC %python
-- MAGIC print(f"SELECT * FROM {DA.catalog_name_prefix}.gold.heartrate_avgs")
...
-- MAGIC %python
-- MAGIC print(f"SELECT * FROM {DA.catalog_name_prefix}.silver.heartrate_device ")
...
DROP CATALOG IF EXISTS euheniy_khvoinitski_3tu9_da CASCADE;
