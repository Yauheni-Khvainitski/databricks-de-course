...
-- MAGIC %run "/Workspace/Users/euheniy.khvoinitski@gmail.com/Databricks DE Course/DE 2 - ETL with Spark/Includes/Classroom-Setup-02.3L"

-- COMMAND ----------

-- MAGIC %python
-- MAGIC files = dbutils.fs.ls('dbfs:/mnt/dbacademy-datasets/data-engineer-learning-path/v04/ecommerce/raw/events-kafka/')
-- MAGIC display(files)
...
-- TODO
-- CTAS overwrites the original files. Risky
