...
-- MAGIC %run "/Workspace/Users/euheniy.khvoinitski@gmail.com/data-engineering-with-databricks/DE 6 - Managing Permissions/Includes/Classroom-Setup-06.2"
...
-- MAGIC %python
-- MAGIC print(f"SELECT * FROM {DA.my_new_catalog}.patient_gold.heartrate_stats")
...
SHOW GRANT ON TABLE ${DA.my_new_catalog}.patient_gold.heartrate_stats
...
SHOW TABLES IN ${DA.my_new_catalog}.patient_silver;

-- COMMAND ----------

SHOW GRANT ON TABLE ${DA.my_new_catalog}.patient_silver.heartrate
...
SHOW GRANT ON SCHEMA ${DA.my_new_catalog}.patient_silver
...
SHOW GRANT ON CATALOG `${DA.my_new_catalog}`
